...
EXTERNAL_SHA="aa4cfdeb17e3559fe1e80175c7338e065553dce5"

PATCHSET="musb-cppi dma rtc pinctrl cpufreq adc i2c da8xx-fb pwm mmc crypto 6lowpan capebus arm omap omap_sakoman omap_beagle_expansion omap_beagle omap_panda net drm not-capebus pru usb PG2 reboot iio w1 gpmc mxt ssd130x build"
